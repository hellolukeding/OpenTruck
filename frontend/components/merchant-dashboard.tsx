...
export function MerchantHero({ dashboard }: { dashboard: MerchantDashboardData | null }) {
  return (
    <section className="relative overflow-hidden rounded-xl border border-outline-variant/30 bg-primary-container text-on-primary-container shadow-sm">
      <div className="absolute top-0 right-0 p-lg">
        <button className="flex items-center gap-xs rounded-lg bg-white/20 px-md py-sm text-body-sm font-medium transition-colors hover:bg-white/30">
...
export function MerchantKeysCard({ dashboard }: { dashboard: MerchantDashboardData | null }) {
  ...
  return (
    <section className="overflow-hidden rounded-xl border border-outline-variant/30 bg-surface-container-lowest shadow-sm">
      <SectionHeader icon="key" title="OpenTruck Keys" count={keys.length} actionLabel="新建" />
...
export function MerchantBookmarks({ dashboard }: { dashboard: MerchantDashboardData | null }) {
  ...
  return (
    <section className="overflow-hidden rounded-xl border border-outline-variant/30 bg-surface-container-lowest shadow-sm">
      <div className="flex items-center justify-between border-b border-outline-variant/20 px-lg py-md">
        ...
        <a className="flex items-center gap-xs text-body-sm text-primary hover:underline" href="/merchant">
          浏览商家
...
export function MerchantModelsTable({ dashboard }: { dashboard: MerchantDashboardData | null }) {
  return <MerchantModelsTableSection dashboard={dashboard} />;
}
