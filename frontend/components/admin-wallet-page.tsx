          ...
          <div className="px-6 pb-6">
            ...
            <div className="mt-6 grid gap-6 lg:grid-cols-[0.9fr_1.1fr]">
              <div>
                ...
                <div className="mt-6 rounded-[20px] border border-outline-variant/20 bg-surface dark:bg-surface-container-low">
                  ...
                  <div className="p-5">
                    ...
                    <div className="mt-5 overflow-hidden rounded-[16px] border border-outline-variant/20">
                      <div className="grid grid-cols-[140px_1fr_96px]">
                        ...
                        <div className="bg-surface px-4 py-3 text-[0.9rem] text-on-surface">https://subrouter.ai/register?aff=40Eq</div>
