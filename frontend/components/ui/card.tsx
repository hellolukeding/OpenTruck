...
>(({ className, ...props }, ref) => (
  <div ref={ref} className={cn("p-lg border-b border-outline-variant", className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <p ref={ref} className={cn("font-body-md text-body-md text-on-surface-variant mt-xs", className)} {...props} />
));
